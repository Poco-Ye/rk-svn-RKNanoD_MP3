...
void MedialibWinValueInit(void *pArg)
{
    ...
    gMusicTypeSelID            = ((MEDIAWIN_WIN_ARG*)pArg)->CurId;
    MedialibWinItemData.CurNum = ((MEDIAWIN_WIN_ARG*)pArg)->CurId;//
    //not change SORT_TYPE_SEL_FOLDER value to remove playlist item
    if (MedialibWinItemData.CurNum == SORT_TYPE_SEL_FOLDER)
        MedialibWinItemData.CurNum = SORT_TYPE_PLAY_LIST;
    ...
    {
        //not change SORT_TYPE_SEL_FOLDER value to remove playlist item
        if (MedialibWinItemData.CurNum == SORT_TYPE_PLAY_LIST)  //ESC from BrowserUI
        {
            gMusicTypeSelID            = ((MEDIAWIN_WIN_ARG*)pArg)->CurId;
            MedialibWinItemData.CurNum = ((MEDIAWIN_WIN_ARG*)pArg)->CurId;//
        }
        ...
        {
            gMusicTypeSelID            = ((MEDIAWIN_WIN_ARG*)pArg)->CurId + 1;
            MedialibWinItemData.CurNum = ((MEDIAWIN_WIN_ARG*)pArg)->CurId + 1;//
        }
...
UINT32 SortedMusicMode(UINT16 MusicTypeSelID)
{
    ...
    RetVal = 0;
    //not change SORT_TYPE_SEL_FOLDER value to remove playlist item
    if (MusicTypeSelID == SORT_TYPE_PLAY_LIST)
        MusicTypeSelID = SORT_TYPE_SEL_FOLDER;
...
UINT32 MedialibWinKey(void)
{
    ...
    switch (MedialibKeyVal)
    {
        ...
        case KEY_VAL_MENU_SHORT_UP:
            RetVal = SortedMusicMode((UINT16)MedialibWinItemData.CurNum); //enter the specific favourite
            break;
