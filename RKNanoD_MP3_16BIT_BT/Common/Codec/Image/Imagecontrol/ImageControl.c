...
static BOOLEAN ImagegetFileName(UINT16 FsType)  /*<--sanshin 0612*/
#else                                           /*<--sanshin 0612*/
...
#endif                                          /*<--sanshin 0612*/
{
    ...
    gwSaveDirClus = 0;
#ifdef PIC_MEDIA                                                                                                        /*<--sanshin 0612*/
    GetLongFileName(PicSysFileInfo.FindData.Clus, PicSysFileInfo.FindData.Index - 1, FsType, PicFileInfo.LongFileName); /*<--sanshin 0612*/
        return TRUE;                                                                                                    /*<--sanshin 0612*/
#else                                                                                                                   /*<--sanshin 0612*/
...
#ifdef PIC_MEDIA                        /*<--sanshin 0612*/
static void ImageStart(UINT16 FsType)   /* <--sanshin 0612*/
#else                                   /*<--sanshin 0612*/
...
#ifdef PIC_MEDIA                    /*<--sanshin 0612*/
    ret = ImagegetFileName(FsType); /*<--sanshin 0612*/
#else                               /*<--sanshin 0612*/
...
#ifdef PIC_MEDIA                                                                                                                                            /*<--sanshin 0612*/
    pImageFileHandle = (FILE*)FileOpen(PicSysFileInfo.Fdt.Name, PicSysFileInfo.FindData.Clus, PicSysFileInfo.FindData.Index - 1, FsType, FileOpenStringR);  /*<--sanshin 0612*/
#else                                                                                                                                                       /*<--sanshin 0612*/
...
#ifdef PIC_MEDIA                                                                    /*<--sanshin 0612*/
    if(
        (JPEG_DB == gbFsType)                               /*<--sanshin 0706*/
        ||                                                  /*<--sanshin 0706*/
        (FS_FAT == gbFsType)                            /*<--sanshin 0706*/

    ){
        if (msg)                                                                    /*<--sanshin 0612*/
        {                                                                           /*<--sanshin 0612*/
            gbPicFileNum++;                                                         /*<--sanshin 0612*/
                                                                                    /*<--sanshin 0612*/
            if(gbPicFileNum >= (gbStartFileNum + PicSysFileInfo.TotalFiles)){       /*<--sanshin 0612*/
                gbPicFileNum = gbStartFileNum;                                      /*<--sanshin 0612*/
            }                                                                       /*<--sanshin 0612*/
                                                                                    /*<--sanshin 0612*/
        }else{                                                                      /*<--sanshin 0612*/
                                                                                    /*<--sanshin 0612*/
            gbPicFileNum--;                                                         /*<--sanshin 0612*/
            if (gbPicFileNum < gbStartFileNum)                                      /*<--sanshin 0612*/
            {                                                                       /*<--sanshin 0612*/
                gbPicFileNum = (gbStartFileNum + PicSysFileInfo.TotalFiles) -1;     /*<--sanshin 0612*/
            }                                                                       /*<--sanshin 0612*/
        }                                                                           /*<--sanshin 0612*/
                                                                                    /*<--sanshin 0612*/
        PicSysFileInfo.FindData.Index = gbPicFileNum;                               /*<--sanshin 0612*/
                                                                                    /*<--sanshin 0612*/
    }else{                                                                          /*<--sanshin 0612*/
        if (msg)                                                                    /*<--sanshin 0612*/
        {                                                                           /*<--sanshin 0612*/
            gbPicFileNum++;                                                         /*<--sanshin 0612*/
            if (gbPicFileNum > PicSysFileInfo.TotalFiles )                          /*<--sanshin 0612*/
            {                                                                       /*<--sanshin 0612*/
                gbPicFileNum = 1;                                                   /*<--sanshin 0612*/
            }                                                                       /*<--sanshin 0612*/
        }                                                                           /*<--sanshin 0612*/
        else                                                                        /*<--sanshin 0612*/
        {                                                                           /*<--sanshin 0612*/
            gbPicFileNum--;                                                         /*<--sanshin 0612*/
            if (gbPicFileNum == 0)                                                  /*<--sanshin 0612*/
            {                                                                       /*<--sanshin 0612*/
                gbPicFileNum = PicSysFileInfo.TotalFiles;                           /*<--sanshin 0612*/
            }                                                                       /*<--sanshin 0612*/
        }                                                                           /*<--sanshin 0612*/
        PicBroGetSavedJpegDir(                                                      /*<--sanshin 0612*/
            &PicSysFileInfo.FindData,                                               /*<--sanshin 0612*/
            PicSysFileInfo.ulFullInfoSectorAddr,                                    /*<--sanshin 0612*/
            PicSysFileInfo.ulSortInfoSectorAddr,                                    /*<--sanshin 0612*/
            gbPicFileNum-1                                                          /*<--sanshin 0612*/
        );                                                                          /*<--sanshin 0612*/
    }                                                                               /*<--sanshin 0612*/
                                                                                    /*<--sanshin 0612*/
...
#ifdef PIC_MEDIA                    /*<--sanshin 0612*/
            ImageStart(gbFsType);     /*<--sanshin 0612*/
#else                               /*<--sanshin 0612*/
            ImageStart();
#endif                              /*<--sanshin 0612*/
            break;
...
#ifdef PIC_MEDIA                                    /*<--sanshin 0612*/
        case MSG_IMAGE_DECSTART_BRO://start decode. /*<--sanshin 0612*/
            ImageStart(gbFsType);                    /*<--sanshin 0612*/
#endif                                              /*<--sanshin 0612*/
...
void PictureInit(void *pArg)
{
    ...
    gbPicFromWhere = ((PICTURE_THREAD_ARG*)pArg)->FromWhere;            /*<--sanshin_20150703*/

#ifdef PIC_MEDIA
    gbFsType = ((PICTURE_THREAD_ARG*)pArg)->FsType;                     /*<--sanshin 0612*/
    gbStartFileNum = ((PICTURE_THREAD_ARG*)pArg)->StartFileNum;         /*<--sanshin 0612*/
#endif
...
#ifdef PIC_MEDIA                            /*<--sanshin 0612*/
    if(FS_FAT == gbFsType){                 /*<--sanshin 0612*/
        SendMsg(MSG_IMAGE_DECSTART);        /*<--sanshin 0612*/
    }else{                                  /*<--sanshin 0612*/
        SendMsg(MSG_IMAGE_DECSTART_BRO);    /*<--sanshin 0612*/
    }                                       /*<--sanshin 0612*/
#else                                       /*<--sanshin 0612*/
    SendMsg(MSG_IMAGE_DECSTART);
#endif                                      /*<--sanshin 0612*/
    //ImageDecodeProc(MSG_IMAGE_DECSTART,NULL) ;
}
...
#ifdef PIC_MEDIA                                                /*<--sanshin 0612*/
    else if (GetMsg(MSG_IMAGE_DECSTART_BRO))                    /*<--sanshin 0612*/
    {                                                           /*<--sanshin 0612*/
        ImageDecodeProc(MSG_IMAGE_DECSTART_BRO,0);              /*<--sanshin 0612*/
    }
#endif                                                          /*<--sanshin 0612*/
