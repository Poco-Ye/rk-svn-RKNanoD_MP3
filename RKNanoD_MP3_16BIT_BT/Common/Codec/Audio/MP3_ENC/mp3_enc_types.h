...
#define BUFFER_SIZE  2048    /* output buffer size in bytes 576 bytes */
...
unsigned int L3_format_bitstream( int l3_enc[1][1][samp_per_frame2], L3_side_info_t  *l3_side,unsigned char ** ppOutBuf);
...
void L3_iteration_loop(long            mdct_freq_org[1][1][samp_per_frame2],
                       ...
                       int             mean_bits);     
void L3_mdct_sub(long sb_sample[1][3][18][SBLIMIT],
                 long mdct_freq[1][1][samp_per_frame2]);	                    
