...
/*<--sanshin 0612*/
#endif
    uint8 FromWhere;                /*<--sanshin_20150703*/
    uint8 AutoPlaySwitch;           //automatic browse switch
    uint8 AutoPlayTime;             //automatic browse time
    uint16 CurId;                   /*<--sanshin_20150630*/
    uint16 KeyCnt;                  /*<--sanshin_20150630*/
...
typedef __packed struct _MEDIALIBCONFIG
{
    ...
    UINT32 gJpegFileNum;        /*sanshin*/
    UINT16 gJpegTotalFileNum;   /*sanshin*/
#ifdef _M3U_
    UINT32 gM3uFileNum;         //<----sanshin_20150616
    UINT16 gM3uTotalFileNum;    //<----sanshin_20150616
#endif

}MEDIALIB_CONFIG;


typedef __packed struct _SYS_PICBRO_DIR_TREE_STRUCT //Ub8v=a991XPk:MC=LeDG1_6(Re5D=a99O`M,
{
    UINT8  Flag;//JG7qPhR*J9SC8C=a99LeJ}>];V84WJT4PEO"5D1j<G
    UINT8  MediaType;
...
//---->sanshin_20150616
typedef __packed struct _SYS_M3UBRO_DIR_TREE_STRUCT     //<----sanshin_20150616
{                                                       //<----sanshin_20150616
    UINT8  Flag;                                        //<----sanshin_20150616
    UINT8  MediaType;                                   //<----sanshin_20150616
    UINT16 DirBaseSortId[4];                            //<----sanshin_20150616
    UINT16 DirDeep;                                     //<----sanshin_20150616
    UINT16 CurId[4];                                    //<----sanshin_20150616
}SYS_M3UBRO_DIR_TREE_STRUCT;                            //<----sanshin_20150616
//<----sanshin_20150616
...
typedef __packed struct _SYSCONFIG
{
    ...
    UINT8  AvlsEnabled;//PAGE
    UINT8  BeepEnabled;//PAGE
...
#ifdef _M3U_
EXT _ATTR_SYS_BSS_ UINT16 gM3uTypeSelName[SYS_SUPPROT_STRING_MAX_LEN + 1];  //<----sanshin_20150616
#endif
...
#ifdef PIC_MEDIA
/*sanshin 0612 --->*/
#define  gbFsType               gSysConfig.PicConfig.FsType         /*<--sanshin 0612*/
#define  gbStartFileNum         gSysConfig.PicConfig.StartFileNum   /*<--sanshin 0612*/
/*<--sanshin 0612*/
#endif
#define  gbPicCurid             gSysConfig.PicConfig.CurId          /*<--sanshin_20150630*/
#define  gbPicKeyCnt            gSysConfig.PicConfig.KeyCnt         /*<--sanshin_20150630*/
#define  gbPicFromWhere         gSysConfig.PicConfig.FromWhere      /*<--sanshin_20150703*/
...
_ATTR_SYS_DATA_ EXT char        AudioFileExtString[]   = "MP1MP2MP3WMAWAVREVFLAAACM4AREVMP43GP";
_ATTR_SYS_DATA_ EXT char        MusicFileExtString[]   = "MP1MP2MP3WMAWAVREVFLAAACM4AREVMP43GP";
...
_ATTR_SYS_DATA_ EXT BOOL        gIsMusicWinFlg;     //<----sanshin_20151026
