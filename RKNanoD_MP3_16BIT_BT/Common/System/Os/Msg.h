...
typedef enum
{
    ...
    MSG_NO_FILE,
    MSG_MESSAGEBOX_KEY_ESC,
    MSG_MESSAGEBOX_KEY_NEXT,
    MSG_MESSAGEBOX_KEY_PREV,
    MSG_MESSAGEBOX_KEY_MENU,
...
#ifdef PIC_MEDIA
/*sanshin 0612 --->*/
    MSG_IMAGE_DECSTART_BRO,             /*<-- sanshin 0612*/
/*<--sanshin 0612*/
#endif
    MSG_IMAGE_DEC,
    MSG_IMAGE_PAUSE,
    ...
    //MSG_MEDIABRO_FRESH_THUMBNAIL,     //<----sanshin_20150625
	MSG_MEDIABRO_FRESH_THUMBNAIL_UP,    //<----sanshin_20151110
    MSG_MEDIABRO_FRESH_THUMBNAIL_DOWN,  //<----sanshin_20151110
    MSG_MEDIABRO_UPDATE_THUMBNAIL,  //<----sanshin_20151026
    ...
    MSG_PICBRO_FRESH_THUMBNAIL,             //<----sanshin_20150625
...
#ifdef _M3U_
    //----->sanshin_20150616
    MSG_M3UBRO_DISPLAY_ALL,                     //<-----sanshin_20150616
    MSG_M3UBRO_ALL_ITEM,                        //<-----sanshin_20150616
    MSG_M3UBRO_FRESH_ITEM,                      //<-----sanshin_20150616
    MSG_M3UBRO_DISPFLAG_SCROLL_FILENAME,        //<-----sanshin_20150616
    MSG_M3UBRO_NOFIND_FILE,                     //<-----sanshin_20150616
    MSG_M3UBRO_DISPLAY_FILE_ALL,                //<-----sanshin_20150616
    MSG_M3UBRO_DISPLAY_FILE_FRESH,              //<-----sanshin_20150616
                                                //<-----sanshin_20150616
    MSG_M3U_DIS_ALL,                            //<-----sanshin_20150616
    MSG_M3U_DIS_BAR,                            //<-----sanshin_20150616
    MSG_M3U_DIS_ALL_ITEM,                       //<-----sanshin_20150616
    MSG_M3U_DIS_SELE_ITEM,                      //<-----sanshin_20150616
    MSG_M3U_DIS_BATT,                           //<-----sanshin_20150616
    MSG_M3U_DIS_HOLD,                           //<-----sanshin_20150616
    MSG_M3U_DIS_SCLLO_ITEM,                     //<-----sanshin_20150616
    M3U_DISPFLAG_SCROLL_FILENAME,               //<-----sanshin_20150616
    MSG_M3U_DELETE_FILE,                        //<-----sanshin_20150616
    MSG_M3U_DELETEING_FILE,                     //<-----sanshin_20150616
    MSG_M3U_FROM_MAINMENU,                      //<-----sanshin_20150616
    MSG_M3U_CHECK_FILE,                         //<-----sanshin_20150616
    MSG_M3U_NOFIND_FILE,                        //<-----sanshin_20150623
    //<-----sanshin_20150616
#endif
    ...
    MSG_BLUETOOTH_SBC_BITPOOLMAX_CHANGED,
