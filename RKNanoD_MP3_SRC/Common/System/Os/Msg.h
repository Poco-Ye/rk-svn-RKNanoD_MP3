...
#ifdef _M3U_
    MSG_M3UBRO_DISPLAY_ALL,
    MSG_M3UBRO_ALL_ITEM,
    MSG_M3UBRO_FRESH_ITEM,
    MSG_M3UBRO_DISPFLAG_SCROLL_FILENAME,
    MSG_M3UBRO_NOFIND_FILE,
    MSG_M3UBRO_DISPLAY_FILE_ALL,
    MSG_M3UBRO_DISPLAY_FILE_FRESH,

    MSG_M3U_DIS_ALL,
    MSG_M3U_DIS_BAR,
    MSG_M3U_DIS_ALL_ITEM,
    MSG_M3U_DIS_SELE_ITEM,
    MSG_M3U_DIS_BATT,
    MSG_M3U_DIS_HOLD,
    MSG_M3U_DIS_SCLLO_ITEM,
    M3U_DISPFLAG_SCROLL_FILENAME,
    MSG_M3U_DELETE_FILE,
    MSG_M3U_DELETEING_FILE,
    MSG_M3U_FROM_MAINMENU,
    MSG_M3U_CHECK_FILE,
    MSG_M3U_NOFIND_FILE,
#endif
    //BlueTooth message
