...
uint32 AudioCodecGetBufferSize2(int codec, int samplerate)
{
    //Get Codecs output buffersize
    {
        ...
        {
            #ifdef CODEC_24BIT
            CodecBufSize2 = 4096 * 8;//2730 * 8;                    // 2730*4*2 = 21840 / 2
            #else
            CodecBufSize2 = 4096 * 4;                    // 2730*4*2 = 21840 / 2
            #endif
        }
    #endif
        ...
        {
            CodecBufSize2 = 1176 * 3 * 8;//1176 * 3 * 8  ;                    // buf
        }
    #endif
        ...
        {
            CodecBufSize2 = 1024 * 3 * 8;// 1024 * 3 * 8 ;                    // 2048*4*2 = 16384
        }
    #endif
        else
        {
