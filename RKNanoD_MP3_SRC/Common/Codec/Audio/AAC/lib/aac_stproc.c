 ...
 */
 ...
 //static  int **pow14_stproc =(int **)( base +pow14_stproc_offset);
 static  int pow14_stproc[2][4] = { 
    0xc0000000, 0xb3e407d7, 0xa57d8666, 0x945d819b, 
    0x40000000, 0x4c1bf829, 0x5a82799a, 0x6ba27e65
}; 
 #else 
static  int pow14[2][4] = { 
    0xc0000000, 0xb3e407d7, 0xa57d8666, 0x945d819b, 
    0x40000000, 0x4c1bf829, 0x5a82799a, 0x6ba27e65
};
#endif
                              ...
                              unsigned char *cbRight, short *sfRight, int *gbCurrent)
{
    ...
    for (sfb = 0; sfb < maxSFB; sfb++) {
        ...
        //Bug Fix : Jan 17,2008, By Vincent Hsiung
        if (width<0) return;
        //----------------------------------------
        cbIdx = cbRight[sfb];
        ...
        if (cbIdx == 14 || cbIdx == 15) {
            ...
            scalef = pow14_stproc[cbIdx][sf & 0x03];
