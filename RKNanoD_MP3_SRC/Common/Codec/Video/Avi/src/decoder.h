...
*/
extern MACROBLOCK xvid_mb_pred[XIVD_MAX_MB_WIDTH+1]; 
//extern MACROBLOCK xvid_mb;  // 用于存放当前宏块的信息
...
** [XIVD_MAX_MB_WIDTH+1]: 需要一个宏行 + 左边的一个宏块用来预测
**
[4]                  : 每个宏块用到4个block，y[2], y[3], u, v
** [MBPRED_SIZE]        : 每个block需要保存的预测值数
*/
extern short xvid_intra_pred_values[XIVD_MAX_MB_WIDTH+1][4][MBPRED_SIZE]; 
#endif
