...
dequant_h263_intra_c(int16_t * data,
                      ...
                      uint16_t * mpeg_quant_matrices)
{
     int32_t quant_m_2 = quant << 1;
     int32_t quant_add = (quant & 1 ? quant : quant - 1);
    int i;
...
//{
//     uint16_t quant_m_2 = quant << 1;
//     uint16_t quant_add = (quant & 1 ? quant : quant - 1);
//    int i;
//
//    for (i = 0; i < 64; i++)
//    {
