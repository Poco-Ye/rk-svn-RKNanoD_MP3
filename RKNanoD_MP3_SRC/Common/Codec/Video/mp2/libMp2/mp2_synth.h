...
void mp2_mad_synth_init(struct mad_synth *);

# define mp2_mad_synth_finish(synth)  /* nothing */

void mp2_mad_synth_mute(struct mad_synth *);

void mp2_mad_synth_frame(struct mad_synth *, struct mad_frame const *);
