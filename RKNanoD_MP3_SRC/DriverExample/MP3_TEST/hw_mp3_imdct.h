...
extern volatile int imdct_finish_test;
extern volatile int imdct36_auto_output_addr_test;
...
extern void imdct36_hw_pipeline_test(long *X,long *z);

extern void Hw_imdct_Exit(void);
extern void Hw_imdct_Init(void);

extern void imdct36_handler_test(void);
