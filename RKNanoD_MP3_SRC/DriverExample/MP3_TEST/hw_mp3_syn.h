...
extern void Hw_syn_Exitv(void);
extern void mad_synth_init_test(struct mad_synth *synth);
extern void mp3_wait_synth_test(void);
extern void mad_synth_fouth_frame_test();
extern void synth_handler_test(void);
