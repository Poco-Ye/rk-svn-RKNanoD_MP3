...
void Gpio_Init(void)
{
    ...
    Grf_GpioMuxSet(GPIO_CH2,GPIOPortA_Pin4,IOMUX_GPIO2A4_IO);  Gpio_SetPinDirection(GPIO_CH2,GPIOPortA_Pin4,GPIO_OUT); Gpio_SetPinLevel(GPIO_CH2,GPIOPortA_Pin4,GPIO_HIGH);
#else
    ...
    #ifdef _JTAG_DEBUG_
    Grf_Force_Jtag_Set(1);
    Grf_GpioMuxSet(GPIO_CH2,GPIOPortB_Pin6,IOMUX_GPIO2B6_JTG0_TMS);
    Grf_GpioMuxSet(GPIO_CH2,GPIOPortB_Pin7,IOMUX_GPIO2B7_JTG0_TCK);
    #else
...
/*
--------------------------------------------------------------------------------
  Function name : void PlayPowerOnVoice(void)
  Author        :
  Description   :
  Input         :
  Return        :
