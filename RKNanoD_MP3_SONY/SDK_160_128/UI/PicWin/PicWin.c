...
{
    UINT16  i, index, NextFile;                                         /*<--sanshin_20150702*/
    UINT32 KeyVal;
    UINT16  retval = 0;
    TASK_ARG TaskArg;
    ...
    switch (KeyVal)
    {
        ...
        /*
            ...
            TaskSwitch(TASK_ID_BROWSER, &TaskArg);
        */
        //if(PicWinFromWhere == 1)                                      /*<--sanshin_20150630*//*<--sanshin_20150703*/
        if(gbPicFromWhere == 1)                                         /*<--sanshin_20150703*/
        {
            TaskArg.MediaBro.CurId= gbPicFileNum;
            TaskSwitch(TASK_ID_PICBRO, &TaskArg);
        }                                                               /*<--sanshin_20150630*/
        else                                                            /*<--sanshin_20150630*/
        {                                                               /*<--sanshin_20150630*/
            if(CheckMsg(MSG_BROW_FROM_MAINMENU))                        /*<--sanshin_20150702*/
            {                                                           /*<--sanshin_20150702*/
                TaskArg.Browser.FileType = FileTypeALL;                 /*<--sanshin_20150702*/
                TaskArg.Browser.FileNum = GetGlobeFileNum(PicSysFileInfo.FindData.Index-2, PicSysFileInfo.FindData.Clus, ALLFileExtString, FS_FAT);/*<--sanshin_20150702*/
                TaskArg.Browser.FromWhere = 0;                          /*<--sanshin_20150702*/
                TaskSwitch(TASK_ID_BROWSER, &TaskArg);                  /*<--sanshin_20150702*/
            }
            else
            {
                index = PicSysFileInfo.FindData.Index - gbStartFileNum; /*<--sanshin_20150702*/
                //if(PicSysFileInfo.ucCurDeep == 0)                     /*<--sanshin_20150702*/
                {                                                       /*<--sanshin_20150702*/
                    index++;                                            /*<--sanshin_20150702*/
                }                                                       /*<--sanshin_20150702*/
                TaskArg.Browser.FileType = FileTypePicture;             /*<--sanshin_20150630*/
                TaskArg.Browser.FileNum  = GetGlobeFileNum(index, PicSysFileInfo.FindData.Clus, PictureFileExtString, JPEG_DB);/*<--sanshin_20150630*//*<--sanshin_20150702*/
                //DEBUG("%s : FileNum=%d\n", __FUNCTION__, TaskArg.Browser.FileNum);/*<--sanshin_20150702*/
                TaskArg.Browser.FromWhere = 2;                          /*<--sanshin_20150630*/
                TaskSwitch(TASK_ID_BROWSER, &TaskArg);                  /*<--sanshin_20150630*/
                BroswerFlag = FALSE;                                    /*<--sanshin_20150630*/
            }
        }                                                               /*<--sanshin_20150630*/
        //<-----sanshin
            retval = 1;
