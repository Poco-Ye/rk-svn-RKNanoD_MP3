...
{
#define BUTTON_STATUS_PUSHED 0
#define BUTTON_STATUS_RELEASED 1

    void(*close_notify)(void);
    void(*connected_notify)(void);
    void(*audio_play)(int button_status);
    void(*audio_stop)(int button_status);
    void(*audio_pause)(int button_status);
    void(*audio_next)(int button_status);
    void(*audio_previous)(int button_status);
    void(*audio_volumeup)(int button_status);
    void(*audio_volumedown)(int button_status);
    void(*audio_volume_change)(uint8 volume);
    void(*audio_mute)(int button_status);
    void(*audio_ffd)(int button_status);
    void(*audio_ffw)(int button_status);
};
