...
//_ATTR_RECORD_CONTROL_BSS_       EXT UINT8  __align(4) gRecEncbuf[WAV_ENCODER_WRITE2FLASH_LENGTH * 16];
_ATTR_RECORD_CONTROL_BSS_       EXT UINT8  __align(4) gRecEncbuf[WAV_ENCODER_WRITE2FLASH_LENGTH * 8];
