...
#include "aac_gen_table/aac_table.h"
 ...
 HuffInfo * huffTabSpecInfo =(HuffInfo *)( base +huffTabSpecInfo_offset);
 signed short * huffTabSpec =(signed short *)( base +huffTabSpec_offset);
 HuffInfo *huffTabScaleFactInfo = ( HuffInfo *)(base + huffTabScaleFactInfo_offset);
 signed short * huffTabScaleFact =(signed short *)( base +huffTabScaleFact_offset);
#else
