...
const int  *sampRateTab =(int *)( base +sampRateTab_offset);
const int *predSFBMax = (int *)(base + predSFBMax_offset);
const int *channelMapTab = (int *)(base +channelMapTab_offset);
const int *elementNumChans =(int *)( base +elementNumChans_offset);
const unsigned char *sfBandTotalShort = base +sfBandTotalShort_offset;
const unsigned char  *sfBandTotalLong = base +sfBandTotalLong_offset;

const int *sfBandTabShortOffset =(int *)( base +sfBandTabShortOffset_offset);
const short *sfBandTabShort =(short *)( base +sfBandTabShort_offset);
const int *sfBandTabLongOffset = (int *)(base +sfBandTabLongOffset_offset);
const short *sfBandTabLong = (short *)(base +sfBandTabLong_offset);
const int *tnsMaxBandsShortOffset =(int *)( base +tnsMaxBandsShortOffset_offset);
const unsigned char *tnsMaxBandsShort = base +tnsMaxBandsShort_offset;
const unsigned char *tnsMaxOrderShort = base +tnsMaxOrderShort_offset;
const int *tnsMaxBandsLongOffset=(int *)( base +tnsMaxBandsLongOffset_offset);
const unsigned char *tnsMaxBandsLong = base +tnsMaxBandsLong_offset;
const unsigned char *tnsMaxOrderLong = base +tnsMaxOrderLong_offset;
