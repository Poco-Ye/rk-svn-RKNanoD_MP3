...
static  int * nmdctTab_dct =(int *)( base + nmdctTab_dct_offset);
_ATTR_AACDEC_DATA_RO
static  int  * postSkip_dct =(int *)( base +postSkip_dct_offset) ;


#else
 _ATTR_AACDEC_DATA_RO
static  int nmdctTab_dct[NUM_IMDCT_SIZES] = {128, 1024};
 _ATTR_AACDEC_DATA_RO
static  int postSkip_dct[NUM_IMDCT_SIZES] = {15, 1};
#endif
//¼ÓÃÜ±í¸ñ by vincent hisung
extern unsigned int aac_fft_freq[6];
extern unsigned int aac_fft_low[10];
...
static void PreMultiply(int tabidx, int *zbuf1)
{
    ...
    t = ar1 + ai1;
    __asm{  SMULL   z1, t, sin2a,   t   };  
        
        //z2 = MULSHIFT32(cps2a, ai1) - t;
    __asm{  SMULL   z1, z2, cps2a,  ai1 };  
    z2 = z2 - t;
        
        cms2 = cps2a - 2*sin2a;
        //z1 = MULSHIFT32(cms2, ar1) + t;
    __asm{  SMULL   ar1,    z1, cms2,   ar1 };  
    z1 = z1 + t;
    ...
    t = ar2 + ai2;
    __asm{  SMULL   z1, t, sin2b,   t   };  
        
        //z2 = MULSHIFT32(cps2b, ai2) - t;
    __asm{  SMULL   z1, z2, cps2b,  ai2 };  
    z2 = z2 - t;
        
        cms2 = cps2b - 2*sin2b;
        
        //z1 = MULSHIFT32(cms2, ar2) + t;
    __asm{  SMULL   ar1,    z1, cms2,   ar2 };  
    z1 = z1 + t;
...
static void PostMultiply(int tabidx, int *fft1)
{
    ...
    nmdct = nmdctTab_dct[tabidx];       
    csptr = cos1sin1tab;
    skipFactor = postSkip_dct[tabidx];
    fft2 = fft1 + nmdct - 1;
...
static void PreMultiplyRescale(int tabidx, int *zbuf1, int es)
{
    ...
    __asm{  SMULL   z1, t, sin2a, t };  
        ...
        //z2 = MULSHIFT32(cps2a, ai1) - t;
    __asm{  SMULL   z1, ai1, cps2a, ai1 };  
    z2 = ai1 - t;
        
        cms2 = cps2a - 2*sin2a;
        
        //z1 = MULSHIFT32(cms2, ar1) + t;
    __asm{  SMULL   z1, ar1, cms2, ar1  };  
    z1 = ar1 + t;
    ...
    __asm{  SMULL   z1, t, sin2b, t };  
        ...
        //z2 = MULSHIFT32(cps2b, ai2) - t;
    __asm{  SMULL   z1, ai2, cps2b, ai2 };  
    z2 = ai2 - t;
        
        cms2 = cps2b - 2*sin2b;

        //z1 = MULSHIFT32(cms2, ar2) + t;
    __asm{  SMULL   z1, ar2, cms2, ar2  };  
    z1 = ar2 + t;
...
static void PostMultiplyRescale(int tabidx, int *fft1, int es)
{
    ...
    for (i = nmdct >> 2; i != 0; i--) {
        ...
        //t = MULSHIFT32(sin2, ar1 + ai1);
    t = ar1 + ai1;
    __asm{  SMULL   z,  t, sin2, t  };  

        //z = t - MULSHIFT32(cs2, ai1); 
    __asm{  SMULL   z,  ai1, cs2, ai1   };  
    z = t - ai1;
