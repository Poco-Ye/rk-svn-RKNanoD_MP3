...
typedef struct _id3v2_Header {
    char            Id[3];                          /* 僼傽僀儖幆暿巕乭ID3乭(54h,41h,47h)  */
    unsigned char   Ver[2];                         /* 僞僌偺僶乕僕儑儞 */
    unsigned char   Flg;                            /*  Bit 7:旕摨婜壔(捠忢0)
                                                        Bit 6:奼挘僿僢僟桳
                                                        Bit 5:幚尡拞(捠忢0)
                                                        Bit 4:(v2.4偺傒)僼僢僞桳
                                                        Bit 3~0:0 */
    unsigned char   Size[4];                        /*  ID3v2僿僢僟埲崀偺僒僀僘
                                                        撈帺偺悢抣昞尰傪巊梡偟偰偄傞偺偱埲壓偺幃傪巊偆
                                                        uint32_t val = (((uint8_t)Size[0])<<21) + (((uint8_t)Size[1])<<14) + (((uint8_t)Size[2])<<7) + (uint8_t)Size[3];*/
} ID3V2_HEADER;

/* ID3v23   Frame (ID3v2.2偵偼旕懳墳) */
typedef struct _id3v2_frame {
    char            Id[4];                          /* Frame Id */
    char            Size[4];                        /* Frame Header傪彍偄偨僼儗乕儉偺僒僀僘*/
    char            Flg[2];                         /* 奺庬僼儔僌 */
} ID3V23_FRAME;

/* ID3v22   Frame (ID3v2.3偵偼旕懳墳) */
typedef struct _id3v22_frame {
    char            Id[3];                          /* Frame Id */
    char            Size[3];                        /* Frame Header傪彍偄偨僼儗乕儉偺僒僀僘*/
} ID3V22_FRAME;
...
typedef struct _txt_info_frame_v22 {
    ID3V22_FRAME    Fheader;                        /* 僼儗乕儉僿僢僟 */
    char            Txtencode;                      /* 僥僉僗僩僄儞僐乕僨傿儞僌 */
    unsigned short  TxtBom;                         /* BOM */
} TXT_INFO_FRAME_V22;

/* Text Infomation Frame(v2.3) */
typedef struct _txt_info_frame_v23 {
    ID3V23_FRAME    Fheader;                        /* 僼儗乕儉僿僢僟 */
    char            Txtencode;                      /* 僥僉僗僩僄儞僐乕僨傿儞僌 */
    unsigned short  TxtBom;                         /* BOM */
} TXT_INFO_FRAME_V23;

typedef struct _ID3_TAG_INDEX_V22 {
    enum ID3FrameInfo    frame;
    char            tagbuf[4];
} ID3_TAG_INDEX_V22;

typedef struct _ID3_TAG_INDEX_V23 {
    enum ID3FrameInfo    frame;
    char            tagbuf[5];
} ID3_TAG_INDEX_V23;
...
#if 0
        if ((*pUnicode == 0x005C) && (Language == LANGUAGE_JAPANESE))      //SONY 字库需求
        {
            printf("Language = %d\n", Language);
...
******************************************************/
#if 0
_ATTR_ID3_TEXT_ ID3_TAG_INDEX_V22 id3_tag_index_V22_table[]=
{
    ID3_TITLE,        "TT2",
    ID3_ALBUM,        "TAL",
    ID3_ARTIST,       "TP1",
    ...
    ID3_NOTUSEDFRAME, "TBP",
    ID3_NOTUSEDFRAME, "TCM",
    ID3_NOTUSEDFRAME, "TCR",
    ID3_NOTUSEDFRAME, "TDA",
    ID3_NOTUSEDFRAME, "TDY",
    ID3_NOTUSEDFRAME, "TEN",
    ID3_NOTUSEDFRAME, "TFT",
    ID3_NOTUSEDFRAME, "TIM",
    ID3_NOTUSEDFRAME, "TKE",
    ID3_NOTUSEDFRAME, "TLA",
    ID3_NOTUSEDFRAME, "TLE",
    ID3_NOTUSEDFRAME, "TMT",
    ID3_NOTUSEDFRAME, "TOA",
    ID3_NOTUSEDFRAME, "TOF",
    ID3_NOTUSEDFRAME, "TOL",
    ID3_NOTUSEDFRAME, "TOR",
    ID3_NOTUSEDFRAME, "TOT",
    ID3_NOTUSEDFRAME, "TP2",
    ID3_NOTUSEDFRAME, "TP3",
    ID3_NOTUSEDFRAME, "TP4",
    ID3_NOTUSEDFRAME, "TPA",
    ID3_NOTUSEDFRAME, "TPB",
    ID3_NOTUSEDFRAME, "TRC",
    ID3_NOTUSEDFRAME, "TRD",
    ID3_NOTUSEDFRAME, "TRK",
    ID3_NOTUSEDFRAME, "TSI",
    ID3_NOTUSEDFRAME, "TSS",
    ID3_NOTUSEDFRAME, "TT1",
    ID3_NOTUSEDFRAME, "TT3",
    ID3_NOTUSEDFRAME, "TXT",
    ID3_NOTUSEDFRAME, "TXX",
    ID3_NOTUSEDFRAME, "TYE",
    ID3_NOTUSEDFRAME, "PIC",
    ID3_NOTUSEDFRAME, "POP",
    ID3_NOTUSEDFRAME, "COM",
    ID3_NOTUSEDFRAME, "CRA",
    ID3_NOTUSEDFRAME, "CRM",
    ID3_NOTUSEDFRAME, "CNT",
    ID3_NOTUSEDFRAME, "UFI",
    ID3_NOTUSEDFRAME, "ULT",
    ID3_NOTUSEDFRAME, "EQU",
    ID3_NOTUSEDFRAME, "ETC",
    ID3_NOTUSEDFRAME, "GEO",
    ID3_NOTUSEDFRAME, "IPL",
    ID3_NOTUSEDFRAME, "LNK",
    ID3_NOTUSEDFRAME, "MCI",
    ID3_NOTUSEDFRAME, "MLL",
    ID3_NOTUSEDFRAME, "BUF",
    ID3_NOTUSEDFRAME, "RVA",
    ID3_NOTUSEDFRAME, "REV",
    ID3_NOTUSEDFRAME, "SLT",
    ID3_NOTUSEDFRAME, "STC",
    ID3_NOTUSEDFRAME, "WCM",
    ID3_NOTUSEDFRAME, "WCP",
    ID3_NOTUSEDFRAME, "WAF",
    ID3_NOTUSEDFRAME, "WAR",
    ID3_NOTUSEDFRAME, "WAS",
    ID3_NOTUSEDFRAME, "WPB",
    ID3_NOTUSEDFRAME, "WXX",

};

_ATTR_ID3_TEXT_ ID3_TAG_INDEX_V23 id3_tag_index_V23_table[]=
{
    ID3_TITLE,        "TIT2",
    ID3_ALBUM,        "TALB",
    ID3_ARTIST,       "TPE1",
    ...
    ID3_NOTUSEDFRAME, "TEXT",
    ID3_NOTUSEDFRAME, "TORY",
    ID3_NOTUSEDFRAME, "TOAL",
    ID3_NOTUSEDFRAME, "TOFN",
    ID3_NOTUSEDFRAME, "TOLY",
    ID3_NOTUSEDFRAME, "TOWN",
    ID3_NOTUSEDFRAME, "TRDA",
    ID3_NOTUSEDFRAME, "TRSN",
    ID3_NOTUSEDFRAME, "TRSO",
    ID3_NOTUSEDFRAME, "TIME",
    ID3_NOTUSEDFRAME, "TIT1",
    ID3_NOTUSEDFRAME, "TIT3",
    ID3_NOTUSEDFRAME, "TIPL",
    ID3_NOTUSEDFRAME, "TBPM",
    ID3_NOTUSEDFRAME, "TPE2",
    ID3_NOTUSEDFRAME, "TPE3",
    ID3_NOTUSEDFRAME, "TPE4",
    ID3_NOTUSEDFRAME, "TPOS",
    ID3_NOTUSEDFRAME, "TPUB",
    ID3_NOTUSEDFRAME, "TPRO",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TDAT",
    ID3_NOTUSEDFRAME, "TDLY",
    ID3_NOTUSEDFRAME, "TDEN",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TDOR",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TDRC",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TDRL",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TDTG",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TLEN",
    ID3_NOTUSEDFRAME, "TLAN",
    ID3_NOTUSEDFRAME, "TFLT",
    ID3_NOTUSEDFRAME, "TKEY",
    ID3_NOTUSEDFRAME, "TMED",
    ID3_NOTUSEDFRAME, "TMCL",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TMOO",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TSIZ",
    ID3_NOTUSEDFRAME, "TSRC",
    ID3_NOTUSEDFRAME, "TSSE",
    ID3_NOTUSEDFRAME, "TSOA",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TSOP",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TSOT",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TSST",   //ID3V2.4
    ID3_NOTUSEDFRAME, "TXXX",
    ID3_NOTUSEDFRAME, "COMR",
    ID3_NOTUSEDFRAME, "AENC",
    ID3_NOTUSEDFRAME, "ASPI",
    ID3_NOTUSEDFRAME, "GRID",
    ID3_NOTUSEDFRAME, "MCID",
    ID3_NOTUSEDFRAME, "MLLT",
    ID3_NOTUSEDFRAME, "ENCR",
    ID3_NOTUSEDFRAME, "EQU2",   //ID3V2.4
    ID3_NOTUSEDFRAME, "EQUA",
    ID3_NOTUSEDFRAME, "ETCO",
    ID3_NOTUSEDFRAME, "IPLS",
    ID3_NOTUSEDFRAME, "LINK",
    ID3_NOTUSEDFRAME, "OWNE",
    ID3_NOTUSEDFRAME, "PRIV",
    ID3_NOTUSEDFRAME, "PCNT",
    ID3_NOTUSEDFRAME, "POPM",
    ID3_NOTUSEDFRAME, "POSS",
    ID3_NOTUSEDFRAME, "RBUF",
    ID3_NOTUSEDFRAME, "RVA2",   //ID3V2.4
    ID3_NOTUSEDFRAME, "RVAD",
    ID3_NOTUSEDFRAME, "RVRB",
    ID3_NOTUSEDFRAME, "SYLT",
    ID3_NOTUSEDFRAME, "SYTC",
    ID3_NOTUSEDFRAME, "SEEK",   //ID3V2.4
    ID3_NOTUSEDFRAME, "SIGN",   //ID3V2.4
    ID3_NOTUSEDFRAME, "UFID",
    ID3_NOTUSEDFRAME, "USER",
    ID3_NOTUSEDFRAME, "USLT",
    ID3_NOTUSEDFRAME, "WCOM",
    ID3_NOTUSEDFRAME, "WCOP",
    ID3_NOTUSEDFRAME, "WOAF",
    ID3_NOTUSEDFRAME, "WOAR",
    ID3_NOTUSEDFRAME, "WOAS",
    ID3_NOTUSEDFRAME, "WORS",
    ID3_NOTUSEDFRAME, "WPAY",
    ID3_NOTUSEDFRAME, "WPUB",
    ID3_NOTUSEDFRAME, "WXXX",
...
int ID3_GetFrameInfo(char *tempbuf, int iVersion)
{
    ...
    if (iVersion < 3)
    {
        for (i = 0; i < sizeof(id3_tag_index_V22_table)/sizeof(ID3_TAG_INDEX_V22); i++)
        {
            if (!memcmp(&tempbuf[0], id3_tag_index_V22_table[i].tagbuf, 3))
            {
                iFrameInfo = (int)(id3_tag_index_V22_table[i].frame);
                break;
            }
        }
    ...
    {
        for (i = 0; i < sizeof(id3_tag_index_V23_table)/sizeof(ID3_TAG_INDEX_V23); i++)
        {
            if (!memcmp(&tempbuf[0], id3_tag_index_V23_table[i].tagbuf, 4))
            {
                iFrameInfo = (int)(id3_tag_index_V23_table[i].frame);
                break;
            }
        }
    }
...
static int get_id3_info(FILE *fp, ID3V2X_INFO *Id3V2x)
{
    ...
    if (Id3v2_header.Ver[0] == 0x02)
    {
        ...
        for (cnt = 0; cnt < 4; cnt++)
        {
            FileSeek(pos, SEEK_SET, (HANDLE) fp);               /* 僼儗乕儉僿僢僟傑偱堏摦 */
            res = seek_v22_frame(fp, cnt);                      /* ID3僼儗乕儉傑偱堏摦 */
            if(res < 0)
            {
                //DEBUG("Not Found cnt=%d Frame\n", cnt);//hoshi
            ...
            if(cnt == 0)
            {
                res = parse_v22_frame(fp, (unsigned short *)Id3V2x->id3_title);     /* ID3 僞僀僩儖庢摼 */
            }
            else if(cnt == 1)
            {
                res = parse_v22_frame(fp, (unsigned short *)Id3V2x->id3_singer);    /* ID3 壧庤柤庢摼 */
            }
            else if(cnt == 2)
            {
                res = parse_v22_frame(fp, (unsigned short *)Id3V2x->id3_album);     /* ID3 傾儖僶儉柤庢摼 */
            }
            else if(cnt == 3)
            {
                res = parse_v22_frame(fp, (unsigned short *)Id3V2x->id3_genre);     /* ID3 僕儍儞儖庢摼 */
            }
    ...
    else
    {
        ...
        for (cnt = 0; cnt < 4; cnt++)
        {
            (int) FileSeek(pos, SEEK_SET, (HANDLE) fp);         /* 僼儗乕儉僿僢僟傑偱堏摦 */
            res = seek_v23_frame(fp, cnt);                      /* ID3僼儗乕儉傑偱堏摦 */
            if(res < 0)
            {
                //DEBUG("Not Found cnt=%d Frame\n", cnt);//hoshi
				continue;										//<----sanshin_20151008
            ...
            if(cnt == 0)
            {
                res = parse_v23_frame(fp, (unsigned short *)Id3V2x->id3_title);     /* ID3 僞僀僩儖庢摼 */
            }
            else if(cnt == 1)
            {
                res = parse_v23_frame(fp, (unsigned short *)Id3V2x->id3_singer);    /* ID3 壧庤柤庢摼 */
            }
            else if(cnt == 2)
            {
                res = parse_v23_frame(fp, (unsigned short *)Id3V2x->id3_album);     /* ID3 傾儖僶儉柤庢摼 */
            }
            else if(cnt == 3)
            {
                res = parse_v23_frame(fp, (unsigned short *)Id3V2x->id3_genre);     /* ID3 僕儍儞儖庢摼 */
            }
...
static int seek_iTunes_frame(FILE *fp, int cnt)
{
	...
	total_size = 8;/* ilst僼儗乕儉僒僀僘傪弶婜抣偵愝掕 */	//<----sanshin_20151206
...
/* **************************************** */
/* Endian曄峏                               */
/* 堷悢丗unsigned int ui:little endian val  */
/* **************************************** */
_ATTR_ID3_TEXT_
static unsigned int Lit2Big32bit(unsigned int ui)
{
    /* Little 仺 Big Endian 32bit */
    return
