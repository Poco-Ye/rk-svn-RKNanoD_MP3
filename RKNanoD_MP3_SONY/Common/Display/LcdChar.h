...
typedef struct SCROLL_SRTING_STRUCT
{
    ...
    UINT16    ShiftFlag;
    UINT16    XShiftBits;
    UINT16    XShiftCharSize;
    UINT16    FirstCharShiftBits;
    UINT16    LastCharFlag;
    UINT16    LastCharShiftBits;
    UINT16    *pNextStr;
    UINT16    *pCurStr;
...
_ATTR_LCD_BSS_  EXT UINT16 Special_TaiWen_Buf[2];
...
EXT UINT16 * LCD_NFDispUnicodeChar(UINT16 *);
