...
ExecFunPtr exceptions_table2[NUM_INTERRUPTS] = {
    ...
    (ExecFunPtr)(&Image$$BB_MAIN_STACK$$ZI$$Limit),             //FAULT_ID0_REV = (UINT32)0,
    (ExecFunPtr)Main2,                                          //FAULT_ID1_REV,
    IntDefaultHandler2,                                         //FAULT_ID2_NMI,
    IntDefaultHandler2,                                         //FAULT_ID3_HARD,
    IntDefaultHandler2,                                         //FAULT_ID4_MPU,
    IntDefaultHandler2,                                         //FAULT_ID5_BUS,
    IntDefaultHandler2,                                         //FAULT_ID6_USAGE,
    IntDefaultHandler2,                                         //FAULT_ID7_REV,
    IntDefaultHandler2,                                         //FAULT_ID8_REV,
    IntDefaultHandler2,                                         //FAULT_ID9_REV,
    IntDefaultHandler2,                                         //FAULT_ID10_REV,
	IntDefaultHandler2,                                         //FAULT_ID11_SVCALL,
    IntDefaultHandler2,                                         //FAULT_ID12_DEBUG,
    IntDefaultHandler2,                                         //FAULT_ID13_REV,
	IntDefaultHandler2,                                         //FAULT_ID14_PENDSV,
    IntDefaultHandler2,                                         //FAULT_ID15_SYSTICK,

    //RKNano Process Intterupt
    IntDefaultHandler2,                                         //INT_ID_SFC,
    IntDefaultHandler2,                                         //INT_ID_SYNTH,
    IntDefaultHandler2,                                         //INT_ID_EBC,
    IntDefaultHandler2,                                         //INT_ID_EMMC,
    IntDefaultHandler2,                                         //INT_ID_SDMMC,
    IntDefaultHandler2,                                         //INT_ID_USBC,
    IntDefaultHandler2,                                         //INT_ID_DMA,
    IntDefaultHandler2,                                         //INT_ID_IMDCT,
    IntDefaultHandler2,                                         //INT_ID_WDT,
    IntDefaultHandler2,                                         //INT_ID_MAILBOX0,
    IntDefaultHandler2,                                         //INT_ID_MAILBOX1,
    IntDefaultHandler2,                                         //INT_ID_MAILBOX2,
    IntDefaultHandler2,                                         //INT_ID_MAILBOX3,
    IntDefaultHandler2,                                         //INT_ID_REV0,
    IntDefaultHandler2,                                         //INT_ID_REV1,
    IntDefaultHandler2,                                         //INT_ID_REV2,
    IntDefaultHandler2,                                         //INT_ID_PWM1,
    IntDefaultHandler2,                                         //INT_ID_PWM0,
    IntDefaultHandler2,                                         //INT_ID_TIMER1,
    IntDefaultHandler2,                                         //INT_ID_TIMER0,
    IntDefaultHandler2,                                         //INT_ID_SRADC,
    IntDefaultHandler2,                                         //INT_ID_UART5,
    IntDefaultHandler2,                                         //INT_ID_UART4,
    IntDefaultHandler2,                                         //INT_ID_UART3,
    IntDefaultHandler2,                                         //INT_ID_UART2,
    IntDefaultHandler2,                                         //INT_ID_UART1,
    IntDefaultHandler2,                                         //INT_ID_UART0,
    IntDefaultHandler2,                                         //INT_ID_SPI1,
    IntDefaultHandler2,                                         //INT_ID_SPI0,
    IntDefaultHandler2,                                         //INT_ID_I2C2,
    IntDefaultHandler2,                                         //INT_ID_I2C1,
    IntDefaultHandler2,                                         //INT_ID_I2C0,
    IntDefaultHandler2,                                         //INT_ID_I2S1,
    IntDefaultHandler2,                                         //INT_ID_I2S0,
    IntDefaultHandler2,                                         //INT_ID_HIFI,
    IntDefaultHandler2,                                         //INT_ID_PMU,
    IntDefaultHandler2,                                         //INT_ID_GPIO2,
    IntDefaultHandler2,                                         //INT_ID_GPIO1,
    IntDefaultHandler2,                                         //INT_ID_GPIO0,
    IntDefaultHandler2,                                         //INT_ID_VOP,
    IntDefaultHandler2                                          //INT_ID_DMA2,
};
