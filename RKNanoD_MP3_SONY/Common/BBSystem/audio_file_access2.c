...
__align(4)
_ATTR_AUDIO_BSS_ uint8   AudioBuffer2[4];
...
//UINT32 __align(4) MP3_EncodeOutputBuffer[1152];  //Buffer must align 4
#endif
    ...
    {
        {
            ...
            else if (codec == CODEC_FLAC_DEC)
            {
                ...
                CodecBufSize2 = 1024*54 + 320 * 4; // 4096*4*2*1.5  4608*4*2*1.5
                SRC_Num_Forehead = 4608+320;
            ...
            {
                CodecBufSize2 = 1024*48 + 320 * 4;
                SRC_Num_Forehead = 4096+320;
            }
#endif
