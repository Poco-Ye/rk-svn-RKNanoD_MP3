...
/*********************************************************************************************************
** Name :FileFlush
** Description  :update the specified file info.
** Input        :Path, DirFileName:user use filename.
** Output       :RETURN_OK：success
** other reference: the return value explaination in file fat.h
** global   :FileInfo
...
uint8 FindFileSub(FDT *Rt, uint16 FileNum, uint32 DirClus, uint8 *ExtName, FIND_DATA * FindData, FIND_TYPE FindType, FS_TYPE FsType)
{
    ...
    if (FsType == MUSIC_DB)
    {
        while (1)
        {
            ...
            //if(index >= FindData->TotalItem)  /*sanshin 1009*/
            if (index >= (FindData->TotalItem)) /*sanshin 1009*/
            {
                break;
            }
    ...
    {                                                                                                                                                                                                   /*<--sanshin 0612*/
        ...
        {                                                                                                                                                                                               /*<--sanshin 0612*/
            ...
            //if(index >= FindData->TotalItem)  /*sanshin 1009*/                                                                                                                                        /*<--sanshin 0612*/
            if(index >= (FindData->TotalItem))  /*sanshin 1009*/                                                                                                                                        /*<--sanshin 0612*/
            {                                                                                                                                                                                           /*<--sanshin 0612*/
                break;                                                                                                                                                                                  /*<--sanshin 0612*/
            }                                                                                                                                                                                           /*<--sanshin 0612*/
            ...
            index++;                                                                                                                                                                                    /*<--sanshin 0612*/
                                                                                                                                                                                                        /*<--sanshin 0612*/
            //printf("FileTreeBasic.dwNodeFlag = %d\n", FileTreeBasic.dwNodeFlag);                                                                                                                      /*<--sanshin 0612*/
            if(FindType == FIND_TYPE_ALL)                                                                                                                                                               /*<--sanshin 0612*/
            {                                                                                                                                                                                           /*<--sanshin 0612*/
                if (++num == FileNum)                                                                                                                                                                   /*<--sanshin 0612*/
                {                                                                                                                                                                                       /*<--sanshin 0612*/
                    FindData->Index = index;                                                                                                                                                            /*<--sanshin 0612*/
                    if(FileTreeBasic.dwNodeFlag == MEDIA_FILE_TYPE_FILE)                                                                                                                                /*<--sanshin 0612*/
                    {                                                                                                                                                                                   /*<--sanshin 0612*/
                        Rt->Attr &= ~ ATTR_DIRECTORY;                                                                                                                                                   /*<--sanshin 0612*/
                    }                                                                                                                                                                                   /*<--sanshin 0612*/
                    else                                                                                                                                                                                /*<--sanshin 0612*/
                    {                                                                                                                                                                                   /*<--sanshin 0612*/
                        Rt->Attr |= ATTR_DIRECTORY;                                                                                                                                                     /*<--sanshin 0612*/
                    }                                                                                                                                                                                   /*<--sanshin 0612*/
                    FindData->DirOffsetInRDB = temp;                                                                                                                                                    /*<--sanshin 0612*/
                    return (RETURN_OK);                                                                                                                                                                 /*<--sanshin 0612*/
                }                                                                                                                                                                                       /*<--sanshin 0612*/
            }                                                                                                                                                                                           /*<--sanshin 0612*/
            else if(FindType == FIND_TYPE_DIR)                                                                                                                                                          /*<--sanshin 0612*/
            {                                                                                                                                                                                           /*<--sanshin 0612*/
...
uint16 GetTotalFiles(uint32 DirClus, uint8 *ExtName, FS_TYPE FsType)
{
        ...
        if (DirClus != 0xffffffff)
        {
            for (offset = DirClus; ; offset++)
            {
                ...
                */
                ...
                //rk_printf("FileTreeBasic.dwNodeFlag = %d", FileTreeBasic.dwNodeFlag);
                if (FileTreeBasic.dwNodeFlag == MEDIA_FILE_TYPE_FILE)
                {
                    TotalFiles++;
                }
   ...
   {                                                                                                                                                                                                /*<--sanshin 0612*/
        ...
        {                                                                                                                                                                                           /*<--sanshin 0612*/
            for(offset = DirClus; ; offset++)                                                                                                                                                       /*<--sanshin 0612*/
            {                                                                                                                                                                                       /*<--sanshin 0612*/
            #ifdef _WATCH_DOG_
                WatchDogReload();
            #endif

//              DEBUG("%s %d",__FUNCTION__,__LINE__);                                                                                                                                               /*<--sanshin 0612*/
                #if 0                                                                                                                                                                               /*<--sanshin 0612*/
                if(offset % (512 / sizeof(FILE_TREE_BASIC)) == 0)                                                                                                                                   /*<--sanshin 0612*/
                {                                                                                                                                                                                   /*<--sanshin 0612*/
                    MDRead(DataDiskID, MediaInfoAddr + MUSIC_TREE_INFO_SECTOR_START + offset / (512 / sizeof(FILE_TREE_BASIC)), 1, buf);                                                            /*<--sanshin 0612*/
                    FileTreeBasic = (FILE_TREE_BASIC *)buf;                                                                                                                                         /*<--sanshin 0612*/
                }                                                                                                                                                                                   /*<--sanshin 0612*/
                #endif                                                                                                                                                                              /*<--sanshin 0612*/
                                                                                                                                                                                                    /*<--sanshin 0612*/
                MDReadData(DataDiskID,((UINT32)(MediaInfoAddr + JPEG_TREE_INFO_SECTOR_START)<<9) + sizeof(FILE_TREE_BASIC)*(UINT32)(offset), sizeof(FILE_TREE_BASIC), (uint8 *)&FileTreeBasic);     /*<--sanshin 0612*/
                                                                                                                                                                                                    /*<--sanshin 0612*/
                if(FileTreeBasic.dwNodeFlag == MEDIA_FILE_TYPE_FILE)                                                                                                                                /*<--sanshin 0612*/
                {                                                                                                                                                                                   /*<--sanshin 0612*/
                    TotalFiles++;                                                                                                                                                                   /*<--sanshin 0612*/
                }                                                                                                                                                                                   /*<--sanshin 0612*/
                                                                                                                                                                                                    /*<--sanshin 0612*/
...
//          DEBUG("%s end %d",__FUNCTION__,__LINE__);                                                                                                                                               /*<--sanshin 0612*/
        }                                                                                                                                                                                           /*<--sanshin 0612*/
    }                                                                                                                                                                                               /*<--sanshin 0612*/
#endif                                                                                                                                                                                              /*<--sanshin 0612*/
    else
