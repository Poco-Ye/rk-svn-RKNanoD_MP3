...
#define     _ATTR_RECORD_CONTROL_BSS1_            __attribute__( (section("RecordControlBss1"),zero_init) )
...
#define     WAV_ENCODER_BUFFER_NUM              76  //for 320x240 LCD
#else
#define     WAV_ENCODER_BUFFER_NUM              100
#endif
...
_ATTR_RECORD_CONTROL_BSS1_      EXT UINT32 __align(4) WavEncodeInputBuffer[WAV_AD_PIPO_BUFFER_SIZE];  //Buffer must align 4
_ATTR_RECORD_CONTROL_BSS1_      EXT UINT8  __align(4) gRecEncbuf[WAV_ENCODER_WRITE2FLASH_LENGTH * 16];
