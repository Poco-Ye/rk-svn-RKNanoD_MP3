...
power_up:
    ...
    BT_UARTInit(BT_UART_CH,24*1000*1000,115200,UART_DATA_8B,UART_ONE_STOPBIT,UART_PARITY_DISABLE);
    #else
...
int32 Rtk8761aHwDownInitScript(void)
{
    ...
    else
    {
        DelayMs(300);
        #if (BT_UART_INTERFACE_CONFIG == BT_UART_INTERFACE_H4)
        UARTInit(BT_UART_CH,1500000,UART_DATA_8B,UART_ONE_STOPBIT,UART_PARITY_DISABLE);
        #else
