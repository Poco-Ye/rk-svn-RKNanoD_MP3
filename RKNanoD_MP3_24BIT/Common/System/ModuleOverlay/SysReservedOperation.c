...
void LoadSysInformation(void)
{
...
#endif
    DEBUG("mac_size = %d, mac = %2x %2x %2x %2x %2x %2x", mac_size, 
          gSysConfig.BtConfig.LocalBTMacAddr[0],gSysConfig.BtConfig.LocalBTMacAddr[1],
          gSysConfig.BtConfig.LocalBTMacAddr[2],gSysConfig.BtConfig.LocalBTMacAddr[3],
          gSysConfig.BtConfig.LocalBTMacAddr[4],gSysConfig.BtConfig.LocalBTMacAddr[5]);
    if (mac_size != 6)
    {
	...
	gSysConfig.UsbDeviceClass = 0;// 0: MSC; 1: USB Audio;
